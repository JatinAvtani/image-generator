...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-md border hover:scale-105 border-neutral-500 transition-all duration-700'
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-pink-700 w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-md'
